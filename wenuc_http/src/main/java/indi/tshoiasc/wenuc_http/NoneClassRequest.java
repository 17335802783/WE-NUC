...
@WebServlet(name = "noneClass", value = "/noneClass")
public class NoneClassRequest extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String zcd = request.getParameter("zcd");
        String xqj = request.getParameter("xqj");
...
//        }
        ...
        try {
            ...
            JSONObject usl = usr.getNoneClass(zcd, xqj, lh);
            out.println(usl.toString());
            System.out.println(username  + "，执行NoneClass（获取空教室）操作成功");

            //            System.out.println("usl--" + usl);
//            if (usl == null || usl.size() == 0) {
//                out.println(JsonUtils.getJson(0, null, "获取失败"));
//            } else {
//                out.println(JsonUtils.getJson(1, null, ""));
//            }
