...
@WebServlet(name = "tpd", value = "/tpd")
public class TrainingPlanRequestDetail extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if ((username == null) || (password == null) || (_t == null) || (code == null) || (zyh == null)) {
...
//            usr.getUserInfo();
            JSONArray usl = usr.getTrainPlanDetail(zyh);
            if (usl == null) {
                out.println(JsonUtils.getJson(0, null, "获取失败"));
            } else {
                out.println(JsonUtils.getJson(1, usl, ""));
            }
            System.out.println(username + "，执行tpd（获取培养计划详细）操作成功");
